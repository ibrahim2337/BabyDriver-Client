...
const Contact = () => {
  return (
    <div>
      <div className="container px-2 py-12 mx-auto mt-10 lg:mt-12">
        <div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
          <h1 className="text-2xl font-semibold text-center capitalize lg:text-3xl ">
            Our Executive Team
          </h1>
          <div className="flex flex-row flex-wrap-reverse justify-center mt-8">
            <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center bg-slate-300 rounded-md md:w-96 lg:w-80 xl:w-64  ">
              <img
                alt=""
      ...
      <div className="container px-2 py-12 mx-auto lg:px-10">
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 px-7 mx-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          <div className="p-4 rounded-lg   bg-slate-300 text-center md:p-6 ">
          ...
          <div className="p-4 rounded-l bg-gradient-to-r bg-slate-300 text-center md:p-6 ">
            <span className="inline-block p-3 text-blue-500 rounded-lg bg-blue-100/80 ">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          <div className="p-4 rounded-lg bg-gradient-to-r bg-slate-300 text-center md:p-6 ">
            <span className="inline-block p-3 text-blue-500 rounded-lg bg-blue-100/80 ">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          <div className="p-4 rounded-lg bg-gradient-to-r bg-slate-300 md:p-6 text-center">
            <span className="inline-block p-3 text-blue-500 rounded-lg bg-blue-100/80 ">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
